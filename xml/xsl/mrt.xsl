						...
						<tbody>
							...
							<xsl:for-each select="mrt/line/station">
								<tr>
									...
									<td>
										<xsl:for-each select="mrt/line/station//transfer">
											<div>
												<xsl:value-of select="mrt/line/station//transfer/transfer-line"/>
												<xsl:value-of select="mrt/line/station//transfer/transfer-line-sta"/>
											</div>
										</xsl:for-each>
									</td>
								</tr>
